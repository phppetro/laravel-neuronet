      ...
      <div class="chart tab-pane" id="publications">
        <div class="box-body">
            <div class="table-responsive network-participants-image">
                ...
                <a href="/admin/network_diagrams/publications"><img class="img-responsive" src="/img/collaborators.png" alt="Network diagram of collaborating organisations on publications"></a>
            </div>
        </div>
        <!-- /.box-body -->
      </div>
