        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('projects[]', $projects, old('projects') ? old('projects') : $partner->projects->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-projects' , 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('type_of_institution_id', $type_of_institutions, old('type_of_institution_id'), ['class' => 'form-control select2', 'required' => '']) !!}
                    <p class="help-block"></p>
