...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped ajaxTable @can('country_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
                        @can('country_delete')
...
@section('javascript')
    <script>
        ...
        $(document).ready(function () {
            ...
            window.dtDefaultOptions.columns = [@can('country_delete')
                @if ( request('show_deleted') != 1 )
